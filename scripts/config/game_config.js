const GAME_CONFIG = {
    ...
    COLOR_PHENOTYPE_DEFAULT: '#FFFF99',
    COLOR_PHENOTYPE_DEFAULT_LIGHT: '#FFFFCC',
    ...
    PHENOTYPE_GAUGE_SPACING: 3,
    PHENOTYPE_GAUGE_THICKNESS_RATIO: 0.5,
    PHENOTYPE_GLOW_CYCLE_DURATION_MS: 500
};
