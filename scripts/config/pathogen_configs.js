...
const AURA_CONFIG = {
    RAY_DURATION_MS: 2000,
    RAY_POSITIONS_COUNT: 8,
    RAY_ANIMATION_UPDATE_INTERVAL_MS: 16,
    RAY_EASE_OUT_THRESHOLD: 0.7,
    RAY_FADE_OUT_THRESHOLD: 0.7,
    FILLED_CIRCLE_OPACITY_MULTIPLIER: 0.15,
    CIRCLE_OUTLINE_OPACITY_MULTIPLIER: 0.6,
    RAY_OPACITY_MULTIPLIER: 0.8,
    RAY_LINE_WIDTH: 3,
    CUBIC_EASING_POWER: 3,
